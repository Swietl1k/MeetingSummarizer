"""
Django settings for SummarizerProject project.
...
CORS_ALLOWED_ORIGINS = [
    "http://localhost:5500",
    "http://127.0.0.1:5500"  # Dokładny adres frontendu
]
...
WSGI_APPLICATION = 'SummarizerProject.wsgi.application'
...
CSRF_TRUSTED_ORIGINS = [
    "http://localhost:5500",
    "http://127.0.0.1:5500",  # Frontend's domain
]